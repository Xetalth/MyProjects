...
<section class="container">
    <h4 class="center brand-text" style="font-size: 40px; margin-bottom: 24px;">Share a Vacation / View</h4>
    <form action="add_travel.php" method="POST" enctype="multipart/form-data" class="z-depth-1 form-card">
